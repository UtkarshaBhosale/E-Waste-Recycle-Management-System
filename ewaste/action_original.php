...
if(isset($_POST["category"])){	
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#'><h5><b>Product Categories</b></h5></a></li>
	";
...
if(isset($_POST["brand"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#'><h5><b>Brands</h5></b></a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			$bid = $row["brand_id"];
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '</form>';
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="electro@gmail.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/ewaste/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/ewaste/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/ewaste/cancel.php"/>
